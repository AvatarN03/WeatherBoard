...

      {
        weatherData && !loading ? (
          <div className="flex items-start h-full p-4 gap-4 flex-col md:flex-row overflow-y-auto">
            <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col md:flex-col items-stretch justify-start space-y-4">
              <div className="bg-neutral-900/30 backdrop-blur-sm border border-neutral-300/20 p-4 lg:p-8 rounded-lg shrink-0">
                <CurrentWeather data={weatherData!} />
              </div>
              <div className="bg-neutral-800/30 backdrop-blur-sm border border-neutral-300/20 p-4 lg:p-8 rounded-lg shrink-0">
                <h3 className="text-purple-200 mb-4">5 Days Forecast</h3>
                <DailyForecast daily={weatherData.daily} />
              </div>
            </div>

            <div className="w-full md:w-1/2 lg:w-3/4 flex items-start justify-start space-y-4 flex-col">
