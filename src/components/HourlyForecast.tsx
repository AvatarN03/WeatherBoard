            ...
            {hourly.map((h, i) => {
                ...
                return (
                    <div key={i} className="flex flex-col gap-3 flex-shrink-0">
                        <div className="p-4 bg-purple-900/30 border border-purple-500/20 backdrop-blur-sm rounded-lg min-w-[100px] text-center">
                        ...
                        <div className="p-4 bg-purple-900/30 border border-purple-500/20 backdrop-blur-sm rounded-lg min-w-[100px] text-center" title={String(h.wind_direction)}>
                            <p className="text-xs text-purple-400 mb-2">{getHourOnly(h.time)}</p>
