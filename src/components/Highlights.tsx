...
export const Highlights = ({ data }: {data: WeatherData}) => {
    return (
        <div className="">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 w-full items-stretch">
                ...
                <div className="col-span-1">
                    <div className="space-y-4 bg-purple-900/30 border border-purple-500/20 backdrop-blur-sm p-4 rounded-lg h-full">
